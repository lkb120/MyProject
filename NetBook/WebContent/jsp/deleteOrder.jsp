...
<html>
  ...
  <body>
    ...
    <span><a href="/Bookshop/servlet/lookorder">订单浏览</a></span>
    </div>
    <div class="div_guide1">
    <span><a href="/Bookshop/deleorder.jsp">删除订单</a></span>
    </div>
    </div>
    <div class="div_showallbook">
    <p>删除订单</p>
    <form action="/Bookshop/servlet/deleorder" class="div_form" method="post">
    <div class="div_input">
    <label>订单号：</label>
    <input name="deleid">
    </div>
